...
![new User](Fotos/NewUser.jpg)
![new User](Fotos/NewUserstp2.jpg)
![Shares En Ntfs rechten instellen](Fotos/SharesEnNtfs.jpg)
...
![new User](Fotos/IPV4instellen.jpg)
...
**Client:**
![Failed ping](Fotos/FailedPing.jpg)
...
![Fix failed ping](Fotos/FixFailPing.jpg)
![Ping](Fotos/Ping.jpg)
...
![Set-NetConnectionProfile](Fotos/Set-Netconne.jpg)		
...
![Fail login host](Fotos/host faillogin.jpg)
			
			
Van de client krijgen we dit:

![Clientfaillogin](Fotos/clientfaillogin.jpg)
			

Dit is een closeup van de foute login gegevens van de Client:
![closeup](Fotos/closuplogin.jpg)
...
![excelbestandaanmaken](Fotos/excelbestandaanmaken.png)
...
![BeideCLientHost](Fotos/BeideCLientHost.jpg)
